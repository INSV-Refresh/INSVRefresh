...
const I18N_MESSAGES = {
  pt_BR: {
    ...
    price_paid: "Assinatura",
    price_cadence: "pagamento mensal",
  ...
  en: {
    ...
    price_paid: "Subscription",
    price_cadence: "monthly payment",
  ...
  es: {
    ...
    plan_normal: "Pro",
    plan_enterprise: "Empresa",
    price_paid: "Suscripción",
    price_cadence: "pago mensual",
